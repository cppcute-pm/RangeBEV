...
target_dir = 'Boreas_minuse_image_depth_nonprocess'
...
for sequence in sequence_list:
    ...
    for file_name in file_name_list:
        target_file_path = os.path.join(target_sequence_camera_path, file_name.split('.')[0] + '.npy')
        ...
        depth_output = depth
        np.save(target_file_path, depth_output)
