...
if __name__ ==  '__main__':
    ...
    source_dir = os.path.join(data_root, 'Boreas_minuse_163840_to_4096')
    target_dir = os.path.join(data_root, 'Boreas_minuse_163840_to_4096_zip')

    # 创建目标目录，如果它不存在
    os.makedirs(target_dir, exist_ok=True)
    traversal_list = sorted(os.listdir(source_dir))
