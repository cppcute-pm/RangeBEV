...
train_save_path = os.path.join(dataset_root, 'my_tool', f'train_UTM_coords_v3_1_radio_{int(the_radio)}m_additional_num_per_radio_{int(additional_num_of_last)}.npy')
