...
dataset_cfgs=dict(
    ...
    mask_dir_name=None,
    tool_name='my_tool',
    train_coords_filename='train_UTM_coords_v4_80m.npy',
...
unet_path="/home/pengjianyi/.cache/torch/hub/checkpoints/fcn_unet_s5-d16_4x4_512x1024_160k_cityscapes_20211210_145204-6860854e_v2.pth"
freeze_cfgs=dict(
    freeze_imgnet=dict(
        backbone=1,
        aggregate=0,
