...
loss_cfgs = dict(
    loss_type='G1M_triplet_roadmap',
    triplet_loss_cfgs=dict(margin=0.2,
                            normalize_embeddings=True,
                            hard_mining=True,
                            pair_dist_info=False),
    calibration_loss_cfgs=dict(pos_margin=0.9, 
                                neg_margin=0.6),
    smooth_rank_ap_loss_cfgs=dict(tau=0.01,
                                  rho=100.0,
                                  offset=1.0,
                                  delta=0.05,
                                  start=0.0,
    ...
    smooth_rank_ap_loss_weight=0.33,
    calibration_loss_weight=0.33)
