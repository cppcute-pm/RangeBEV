...
model_cfgs=dict(
    ...
    cmvpr2_cfgs=dict(
        ...
        phase7_K=16,
        phase7_max_iter=50,
        phase7_aggregator_mlp_type='NetVLAD',
        phase7_aggregator_mlp_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
        phase7_aggregator_NMF_type='NetVLAD',
        phase7_aggregator_NMF_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
        phase7_aggregator_normal_type='NetVLAD',
        phase7_aggregator_normal_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
...
cct1_path="/home/pengjianyi/.cache/torch/hub/checkpoints/cct_14_7x2_224_imagenet.pth"
cct2_path="/home/pengjianyi/.cache/torch/hub/checkpoints/cct_14_7x2_224_imagenet.pth"
