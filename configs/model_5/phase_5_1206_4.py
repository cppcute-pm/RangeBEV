...
model_cfgs=dict(
    ...
    cmvpr2_cfgs=dict(
        ...
        phase5_attention=True,
        phase5_attention_num_layers=3,
        ...
        attn_pos='after',
        phase5_attention_after_num=1,
        phase5_aggregator_attention_type='GeM',
        phase5_aggregator_attention_cfgs=dict(
            p=3,
            eps=1e-6),
    ),
)
...
dataset_cfgs=dict(
    ...
    image_bev_dir_name='768x128_image_bev_v2_nonground',
