...
model_cfgs=dict(
    ...
    cmvpr2_cfgs=dict(
        ...
        phase5_aggregator2_cfgs=dict(
            p=3,
            eps=1e-6),
        phase5_aggregator_feature_output_type=None,
        ...
        phase5_attention_map=True,
        phase5_fc_attn_feat_type=2,
        phase5_aggregator_attention_map_type='GeM',
        phase5_aggregator_attention_map_cfgs=dict(
            p=3,
            eps=1e-6),
        phase5_two_aggregator_attention=True,
        phase5_attention_map_rerank=True,
    ),
)
...
use_mp=True
evaluator_type = 9
evaluate_9_cfgs = dict(rank_weight1=0.33, 
                       rank_weight2=0.33, 
                       rank_weight3=0.33)
