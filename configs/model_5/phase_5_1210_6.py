...
dataset_cfgs=dict(
    ...
    train_coords_filename='train_UTM_coords_v2_ahead_dist_10m.pkl',
    ...
    overlap_ratio_cfgs=dict(
        exp_scale=0.25),
)

batch_sampler_cfgs = dict(
    batch_sampler_type='ensure_k_levels_pos_uniform_multi_v21',
    num_k=3,
    batch_size=16,
    eval_batch_size=16,
    interval_num=5,
    useout_times=1,
    get_positive_type='v3')
