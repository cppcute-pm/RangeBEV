...
model_cfgs=dict(
    ...
    cmvpr2_cfgs=dict(
        ...
        phase=3,
        phase3_aggregator_type='GeM',
        phase3_aggregator_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
...
resnet2_path="/home/pengjianyi/.cache/torch/hub/checkpoints/fpn_r50_512x512_160k_ade20k_20200718_131734-5b5a6ab9_v2.pth"
