dataset_cfgs = dict(
    ...
    use_pixel_distance_correspndence=False,
    use_original_pc_correspondence_v2=True,
    correspondence_point_project_threshold=200.0,
    )
...
model_cfgs = dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase=22,
        phase22_aggregator_type='GeM',
        phase22_aggregator_cfgs=dict(p=3, eps=1e-06),
        local_positive_overlap_ratio_threshold=0.3,
        local_negative_overlap_ratio_threshold=0.2,
        overlap_matrix_fuse_type='min',
        min_pc_num_pt=5,
        min_img_num_pt=2,
        pair_type="fixed_num",
        pixel_selection_num_each_pair=256,
        points_selection_num=5,
        ),)
loss_cfgs = dict(
