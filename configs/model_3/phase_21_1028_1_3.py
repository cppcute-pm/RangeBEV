dataset_cfgs = dict(
    ...
    use_pixel_distance_correspondence=True,
    pixel_candidate_threshold=3, # need tune
    pixel_selection_method="random_among_batch", # need tune
    pixel_selection_num_all=1024, # need tune
    random_upon_pixel_num=30, # need tune
    points_selection_num=10, # need tune
    pair_positive_dist=2, # need tune
    pair_negative_dist=6, # need tune
    )
...
model_cfgs = dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase=21,
        phase21_aggregator_type='GeM',
        phase21_aggregator_cfgs=dict(p=3, eps=1e-06)))
loss_cfgs = dict(
...
dgcnn_path = None
resnet_path = "/home/test5/.cache/torch/hub/checkpoints/fpn_r50_512x512_160k_ade20k_20200718_131734-5b5a6ab9_v2.pth"
cmvpr_path = None
