...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        cluster_topk=10000,
        semantic_fuse_type='cluster_topk_corresponded',
    ),
)
...
loss_cfgs=dict(
    ...
    cluster_loss_cfgs=dict(
        loss_type='loftr_focal',
        alpha=0.25, # from loftr
        gamma=2.0,
        use_negative=True,
    ),
    ...
    cluster_loss_weight=0.166,
    semantic_in_batch_loss_weight=0.166,
    semantic_all_loss_weight=0.166,
)
