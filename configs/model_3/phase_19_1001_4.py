...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        image_aggregator_type='PoS_GeM',
        image_aggregator_cfgs=dict(
            p=[3, 3, 3, 3, 3],
            eps=[1e-6, 0.0, 0.0, 0.0, 0.0],
            type='type_1',
            ),
        pc_aggregator_type='PoS_GeM',
        ...
        multi_layer=4,
        phase=19,
        phase19_modal_split_aggregator=False,
        phase19_resolution_list=[[112, 112],[56, 56],[28, 28],[7, 7], [1, 1]],
        phase19_aggregator1_type='PoS_GeM',
        phase19_aggregator1_cfgs=dict(
            p=[3, 3],
            eps=[1e-6, 0.0],
            type='type_1',
            ),
        phase19_aggregator2_type='PoS_GeM',
        phase19_aggregator2_cfgs=dict(
            p=[3, 3, 3],
            eps=[1e-6, 0.0, 0.0],
            type='type_1',
            ),
        phase19_aggregator3_type='PoS_GeM',
        phase19_aggregator3_cfgs=dict(
            p=[3, 3, 3, 3],
            eps=[1e-6, 0.0, 0.0, 0.0],
            type='type_1',
            ),
        phase19_aggregator4_type='PoS_GeM',
        phase19_aggregator4_cfgs=dict(
            p=[3, 3, 3, 3, 3],
            eps=[1e-6, 0.0, 0.0, 0.0, 0.0],
            type='type_1',
            ),   
...
pointnext_path="gbvikerl/epoch_65.pth"
resnet_path="vqv4owyh/epoch_41.pth"
cmvpr_path=None
