...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase19_aggregator1_type='GeM',
        phase19_aggregator1_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase19_aggregator2_type='GeM',
        phase19_aggregator2_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase19_aggregator3_type='GeM',
        phase19_aggregator3_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase19_aggregator4_type='GeM',
...
pointnext_path="qvnpd90t/epoch_61.pth"
resnet_path="imv8avw0/epoch_63.pth"
cmvpr_path=None
