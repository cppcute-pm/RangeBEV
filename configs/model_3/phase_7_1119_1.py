...
model_cfgs = dict(
    ...
    cmvpr_cfgs=dict(
        ...
        pc_aggregator_type='NetVLAD',
        pc_aggregator_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,),
        phase=7,
        phase7_aggregator_type='NetVLAD',
        ...
        phase4_min_pc_num_pt=4,
        phase7_attention_embeddings=False,
        phase7_pc_aggr_layer=2,
        phase7_img_aggr_layer=2,
...
loss_cfgs = dict(
    ...
    global_loss_weight=0.6,
    local_loss_weight=0.4,
