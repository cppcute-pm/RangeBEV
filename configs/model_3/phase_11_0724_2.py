...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase=11,
        phase11_aggregator1_type='GeM',
        phase11_aggregator1_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase11_aggregator2_type='GeM',
        phase11_aggregator2_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase11_aggregator2_feature_output_type='fc',
        multi_layer=2,
        phase11_proj_type1=1,
        phase11_proj_type2=1,
        phase11_local_correspondence=True,
