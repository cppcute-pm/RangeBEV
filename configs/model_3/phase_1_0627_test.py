...
dataset_cfgs=dict(
    ...
    # train_coords_filename='train_UTM_coords_v3.npy',
    ...
    # minuse_lidar_filename='train_minuse_lidar_idx_v3.pickle',
    ...
    # positive_distance=10.0 * 1.4142 * 8,
    # non_negative_distance=50.0 * 1.4142 * 8,
    # positive_distance_list=[20.0 * 1.4142 * 8, 
    #                         30.0 * 1.4142 * 8, 
    #                         40.0 * 1.4142 * 8, 
    #                         50.0 * 1.4142 * 8, 
    #                         60.0 * 1.4142 * 8, 
...
#     batch_sampler_type='ensure_k_levels_pos_uniform_multi_v5',
#     num_k=3,
#     batch_size=24,
#     # iter_per_epoch=2000,
#     eval_batch_size=24,
...
# batch_sampler_cfgs=dict(
#     batch_sampler_type='ensure_k_levels_pos_uniform_multi_v6',
#     num_k=3,
#     batch_size=24,
#     # iter_per_epoch=760,
#     eval_batch_size=24,
...
dgcnn_path="9mciy0wi/epoch_71.pth"
resnet_path="qq5lv3ve/epoch_3.pth"
# dgcnn_path=None
cmvpr_path=None
