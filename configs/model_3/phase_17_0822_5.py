...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase=17,
        multi_layer=4,
        phase17_use_four_aggregator=True,
        phase17_aggregator1_type='GeM',
        phase17_aggregator1_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase17_aggregator2_type='GeM',
        phase17_aggregator2_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase17_aggregator3_type='GeM',
        phase17_aggregator3_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase17_aggregator4_type='GeM',
        phase17_aggregator4_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase17_use_SA_block=True,
        phase17_SA_block_aggr_type=1,
        phase17_feat_fuse_type='split',
        phase17_SA_block_aggregator_type='GeM',
        phase17_SA_block_aggregator_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase17_SA_block_cfgs=dict(
            n_head=8,
            num_layers=3),
        phase17_img_sequence_length=49,
        phase17_pc_sequence_length=16,
        phase17_pc_use_pos_emb=True,
    ),
)
