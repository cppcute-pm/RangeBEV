...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        pc_out_layer=None,
        image_encoder_out_layer=10,
        image_encoder_cfgs=dict(
            multi_layer_aggregator=True),
        pc_encoder_type='PointNextv4',
        pc_encoder_out_layer=10,
        ...
        phase=14,
        phase14_aggregator1_type='NetVLAD',
        phase14_aggregator1_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
        phase14_aggregator2_type='NetVLAD',
        phase14_aggregator2_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
        phase14_aggregator3_type='NetVLAD',
        phase14_aggregator3_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
        phase14_aggregator4_type='NetVLAD',
        phase14_aggregator4_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
        phase14_aggregator5_type='NetVLAD',
        phase14_aggregator5_cfgs=dict(
            gating=True,
            add_batch_norm=False,
            cluster_size=64,
            ),
        multi_layer=6,
        phase14_feature_train_type='concat',
        phase4_overlap_matrix_fuse_type="min",
        phase14_local_correspondence_one_layer=False,
        phase14_min_img_num_pt=[104, 6, 2],
        phase14_min_pc_num_pt=[320, 20, 5],
        phase14_topk=[5000, 5000, 500],
    ),
)
...
loss_cfgs=dict(
    loss_type='GL_five_v2_triplet_circle',
    global_loss_cfgs=dict(
        base_margin=0.6,
        normalize_embeddings=False,
        positive_overlap_ratio=0.2,
    ...
    global_loss1_weight=0.167,
    global_loss2_weight=0.167,
    global_loss3_weight=0.167,
    global_loss4_weight=0.167,
    global_loss5_weight=0.167,
    local_loss_weight=0.167,
    local_positive_mask_margin=[0.5, 0.3, 0.3],
    local_negative_mask_margin=[0.2, 0.1, 0.2],
)
