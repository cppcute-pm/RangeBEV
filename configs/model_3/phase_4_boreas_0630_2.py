...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase=4,
        phase4_img_local_layer="fine",
        phase4_pc_local_layer="coarse",
        phase4_img_aggregator_layer="fine",
        phase4_pc_aggregator_layer="coarse",
        phase4_overlap_matrix_modal="pc_and_img",
        phase4_overlap_matrix_fuse_type="mean",
        phase4_min_img_num_pt=250,
        phase4_min_pc_overlap_num_pt=1000,    ),
)
