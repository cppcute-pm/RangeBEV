...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase6_attention_embeddings=False,
        phase6_attention_num_layers=1,
        phase6_attention_n_head=8,
        phase6_attention_out_norm=True,
        phase4_topk=10000,
    ),
)
...
dgcnn_path="tplqein5/epoch_29.pth"
resnet_path="294keqz6/epoch_11.pth"
