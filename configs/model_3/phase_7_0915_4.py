...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase7_attention_embeddings=True,
        ...
        attention_in_local=2,
        phase7_attention_num_layers=3,
        phase7_attention_n_head=8,
        phase7_attention_out_norm=False,
        img_attention_in_local_k=81,
        pc_attention_in_local_k=41,       
    ),
)
...
loss_cfgs=dict(
    loss_type='GL_v3_triplet_circle',
    ...
    local_positive_mask_margin=0.7,
    local_negative_mask_margin=0.3,
)
