_base_ = ['../base/datasets/boreas_v2.py',
            '../base/losses/gl_v2_triplet_cfi2p.py',
...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase4_min_img_num_pt=70,
        phase4_min_pc_overlap_num_pt=250,
        phase5_aggregator_type='GeM',
        phase5_aggregator_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase5_attention_embeddings=True,
        phase5_attention_num_layers=1,
        phase5_attention_n_head=8,
        phase5_attention_out_norm=True,
    ),
)
...
# dgcnn_path="ji0qkevb/epoch_67.pth"
# cct_path="hsp6sjly/epoch_79.pth"
cct_path="/home/test5/.cache/torch/hub/checkpoints/cct_14_7x2_224_imagenet.pth"
dgcnn_path=None
# cmvpr_path="mvc8q4ti/epoch_51.pth"
cmvpr_path=None
