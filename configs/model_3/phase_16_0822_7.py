...
# img feature resolution: [256, 1024, 4096]
# pc feature resolution: [[28, 28], [56, 56], [112, 112]]
...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase=16,
        multi_layer=4,
        phase16_feats_length=3,

        img_attn_re_cfgs=dict(
            high_score_ratio_list=[0.4, 0.4, 0.4],
            low_score_ratio_list=[0.73, 0.73, 0.73],
            sa_cfgs_list=[
                  [dict(with_cp=False,
                        window_size_int=6,
                        mlp_ratio=4,
        ...
        ca_cfgs_list=[
                  ...
                  dict(drop_path_rate=0.,
                       ...
                       pe_multiplier=False,
                       pe_bias=True,),],
        same_res_num_neighbor_list=[8, 8, 8],
        diff_res_num_neighbor_list=[4, 4, 4],
        depth_in_one_layer=1,
        sequence_length=256,
        use_pos_emb=True,
        first_SA_block_cfgs=dict(num_blocks=3,
