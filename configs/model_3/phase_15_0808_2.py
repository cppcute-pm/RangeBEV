...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase15_aggregator_type='GeM',
        phase15_aggregator_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase15_aggregator2_type='GeM',
        phase15_aggregator2_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase=15,
        multi_layer=2,
        phase15_attention_type=2,
        phase15_attention_n_head=8,
        phase15_attention_out_norm=True,
        phase15_attention_num_layers=2,
        phase15_pc_aggr_layer=3,
        phase15_img_aggr_layer=3,
        phase15_pc_local_layer=3,
        phase15_img_local_layer=4,
        phase15_feature_train_type='concat',
        phase4_overlap_matrix_modal="pc_and_img",
        phase4_overlap_matrix_fuse_type="min",
        phase4_min_img_num_pt=104,
        phase4_min_pc_num_pt=320,
