...
model_cfgs=dict(
    ...
    out_dim=256,
    cmvpr_cfgs=dict(
        image_encoder_type='ResUNetmmsegv4',
        image_out_layer=None,
        pc_out_layer=None,
        image_encoder_out_layer=8,
        ...
        pc_encoder_type='PointNextv3',
        pc_encoder_out_layer=8,
        ...
        phase=12,
        phase12_pos_aggregator1=True,
        phase12_pos_aggregator2=True,
        phase12_coords_num_list_1=[16, 1],
        phase12_resolution_list_1=[[7, 7], [1, 1]],
        phase12_coords_num_list_2=[1024, 256, 64, 16, 1],
        phase12_resolution_list_2=[[56, 56], [28, 28], [14, 14], [7, 7], [1, 1]],
        phase12_feature_train_type='concat',
        phase12_aggregator1_type='PoS_GeM',
        phase12_aggregator1_cfgs=dict(
            p=[3, 3],
            eps=[1e-6, 0.0],
            normalize=True,
            ),
        phase12_aggregator2_type='PoS_GeM',
        phase12_aggregator2_cfgs=dict(
            p=[3, 3],
            eps=[1e-6, 0.0],
            normalize=True,
            ),
        phase12_aggregator3_type='PoS_GeM',
        phase12_aggregator3_cfgs=dict(
            p=[3, 3, 3, 3, 3],
            eps=[1e-6, 0.0, 0.0, 0.0, 0.0],
            normalize=True,
            ),
        phase12_aggregator4_type='PoS_GeM',
        phase12_aggregator4_cfgs=dict(
            p=[3, 3, 3, 3, 3],
            eps=[1e-6, 0.0, 0.0, 0.0, 0.0],
            normalize=True,
            ),
        phase12_modal_split_aggregator=True,
        multi_layer=2,
        phase12_local_correspondence=True,
        phase4_overlap_matrix_modal="pc_and_img",
        phase4_overlap_matrix_fuse_type="min",
        phase4_min_img_num_pt=13,
        phase4_min_pc_num_pt=40,
        phase4_topk=5000, # first to tune
        phase4_choose_num=5000, # second to tune, before tune, keep same to phase4_topk        
    ),
)
...
#         gamma=40,
#     ),
#     global_loss1_weight=0.25,
#     global_loss2_weight=0.25,
#     local_loss_weight=0.5,
#     local_positive_mask_margin=0.3,
#     local_negative_mask_margin=0.1,
# )
