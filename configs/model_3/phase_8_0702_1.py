...
model_cfgs=dict(
    ...
    out_dim=256,
    cmvpr_cfgs=dict(
        image_encoder_type='ResFPNmmsegv2',
        ...
        phase=8,
        phase8_aggregator_type='GeM',
        phase8_aggregator_cfgs=dict(
            p=3,
            eps=1e-6,
            ),
        phase4_overlap_matrix_fuse_type="min",
        phase8_min_img_num_pt=[50, 13, 4],
        phase8_min_pc_num_pt=[160, 40, 10],
        phase4_topk=[10000, 10000, 10000],
    ),
)
