...
model_cfgs=dict(
    ...
    cmvpr_cfgs=dict(
        ...
        phase7_pc_aggr_layer=3,
        phase7_img_aggr_layer=3,
        phase7_pc_local_layer=3,
        phase7_img_local_layer=3,
...
dataset_cfgs=dict(
    ...
    mask_dir_name=None,
    rgb_depth_label_dir_name='Boreas_minuse_image_depth_postprocess', # 'Boreas_minuse_image_depth_postprocess'
    tool_name='my_tool',
...
loss_cfgs=dict(
    loss_type='GLD_v2_triplet_circle_silog',
    ...
    depth_loss_cfgs=dict(
        lambd=0.7,
        min_depth=1e-6,
        max_depth=10000.0,
    ),
    global_loss_weight=0.33,
    local_loss_weight=0.33,
    depth_loss_weight=0.33,
