...
import os
import sys
codes_projects_path = os.path.abspath(os.path.join(os.getcwd(), '..'))
openpoints_cpp_path = os.path.join(codes_projects_path,'PointNeXt-master/openpoints')
sys.path.append(openpoints_cpp_path)
from cpp import pointnet2_cuda
sys.path.remove(openpoints_cpp_path)
